-- 0066: get_kpi_targets — thêm actual_ns (ngân sách thực chi từ budget) bên cạnh plan_ns.
-- Cột "Ngân sách" trên báo cáo: nếu ô có thực chi thì lấy actual_ns, nếu chỉ có kế hoạch thì lấy plan_ns.
