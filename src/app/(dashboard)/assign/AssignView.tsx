  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-slate-900">Phân giao</h1>
          <p className="text-sm text-slate-400 mt-0.5">Giao lead chưa có người phụ trách cho tư vấn bán hàng</p>
        </div>
      </div>

      {flash && (
        <div className="px-4 py-2.5 text-sm bg-emerald-50 text-emerald-700 border border-emerald-100 rounded-lg">
          {flash}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          ...
          <p className="text-xs text-slate-400 mt-0.5 mb-3">Số lead đang mở của mỗi tư vấn bán hàng.</p>
          {tvbh.length === 0 ? (
            <p className="text-sm text-slate-400">Chưa có tư vấn bán hàng nào.</p>
          ) : (
