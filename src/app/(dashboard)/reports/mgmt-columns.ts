...
export const MGMT_COLUMNS: MgmtColumn[] = [
  ...
  { key: 'b10On',        label: 'Đã lên B10', color: '#004B9B', bold: true, b10: true,        get: (r) => r.b10On,        total: (t) => t.b10On },
  { key: 'b10Rate',      label: '% B10',      color: '#004B9B', pct: true, b10: true,         get: (r) => r.b10Rate,      total: (t) => t.b10Rate },
