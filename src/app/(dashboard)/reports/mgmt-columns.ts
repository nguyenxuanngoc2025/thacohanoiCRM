...
export const MGMT_COLUMNS: MgmtColumn[] = [
  ...
  { key: 'share',        label: 'Tỷ trọng lead', color: '#64748b', pct: true,                  get: (r) => r.share,        total: () => 100 },
  { key: 'contacted',    label: 'Đã LH',      color: '#1d4ed8',                               get: (r) => r.contacted,    total: (t) => t.contacted },
  { key: 'contactRate',  label: 'Tỷ lệ LH',   color: '#1d4ed8', pct: true,                    get: (r) => r.contactRate,  total: (t) => t.contactRate },
  ...
  { key: 'winRate',      label: 'Tỷ lệ ký HĐ', color: '#047857', pct: true, bold: true,       get: (r) => r.winRate,      total: (t) => t.winRate },
  { key: 'fail',         label: 'Loại',       color: '#be123c',                               get: (r) => r.fail,         total: (t) => t.fail },
  { key: 'failRate',     label: 'Tỷ lệ loại', color: '#be123c', pct: true,                    get: (r) => r.failRate,     total: (t) => t.failRate },
